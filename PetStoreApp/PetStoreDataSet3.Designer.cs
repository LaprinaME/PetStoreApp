...
namespace PetStoreApp {
    ...
    public partial class PetStoreDataSet3 : global::System.Data.DataSet {
        ...
        public partial class ЗаказыDataTable : global::System.Data.TypedTableBase<ЗаказыRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ЗаказыRow AddЗаказыRow(int Id, string Клиент, System.DateTime Дата_заказа, System.DateTime Дата_доставки, string Состав_заказа) {
            ...
            private void InitClass() {
                ...
                this.columnСостав_заказа.MaxLength = 2147483647;
            }
            ...
            public System.DateTime Дата_доставки {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Дата доставки\' in table \'Заказы\' is DBNull.", e);
                    }
                }
                set {
            ...
            public string Состав_заказа {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Состав заказа\' in table \'Заказы\' is DBNull.", e);
                    }
                }
                set {
...
namespace PetStoreApp.PetStoreDataSet3TableAdapters {
    ...
    public partial class ЗаказыTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Заказы] WHERE (([Id] = @Original_Id) AND ((@IsNull_Клиент = 1 AND [Клиент] IS NULL) OR ([Клиент] = @Original_Клиент)) AND ((@IsNull_Дата_заказа = 1 AND [Дата заказа] IS NULL) OR ([Дата заказа] = @Original_Дата_заказа)) AND ((@IsNull_Дата_доставки = 1 AND [Дата доставки] IS NULL) OR ([Дата доставки] = @Original_Дата_доставки)))";
            ...
            param.ParameterName = "@IsNull_Клиент";
            param.DbType = global::System.Data.DbType.Int32;
            param.SqlDbType = global::System.Data.SqlDbType.Int;
            param.IsNullable = true;
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@Original_Клиент";
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@IsNull_Дата_заказа";
            param.DbType = global::System.Data.DbType.Int32;
            param.SqlDbType = global::System.Data.SqlDbType.Int;
            param.IsNullable = true;
            param.SourceColumn = "Дата заказа";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            param.SourceColumnNullMapping = true;
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@Original_Дата_заказа";
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@IsNull_Дата_доставки";
            param.DbType = global::System.Data.DbType.Int32;
            param.SqlDbType = global::System.Data.SqlDbType.Int;
            param.IsNullable = true;
            param.SourceColumn = "Дата доставки";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            param.SourceColumnNullMapping = true;
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@Original_Дата_доставки";
            param.DbType = global::System.Data.DbType.Date;
            param.SqlDbType = global::System.Data.SqlDbType.Date;
            param.IsNullable = true;
            param.SourceColumn = "Дата доставки";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Заказы] ([Id], [Клиент], [Дата заказа], [Дата доставки], [Состав заказа]) VALUES (@Id, @Клиент, @Дата_заказа, @Дата_доставки, @Состав_заказа);
SELECT Id, Клиент, [Дата заказа], [Дата доставки], [Состав заказа] FROM Заказы WHERE (Id = @Id)";
            ...
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@Клиент";
            param.SqlDbType = global::System.Data.SqlDbType.NVarChar;
            param.IsNullable = true;
            param.SourceColumn = "Клиент";
            this._adapter.InsertCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@Дата_заказа";
            param.DbType = global::System.Data.DbType.Date;
            param.SqlDbType = global::System.Data.SqlDbType.Date;
            param.IsNullable = true;
            param.SourceColumn = "Дата заказа";
            this._adapter.InsertCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@Дата_доставки";
            param.DbType = global::System.Data.DbType.Date;
            param.SqlDbType = global::System.Data.SqlDbType.Date;
            param.IsNullable = true;
            param.SourceColumn = "Дата доставки";
            this._adapter.InsertCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@Состав_заказа";
            param.SqlDbType = global::System.Data.SqlDbType.NVarChar;
            param.IsNullable = true;
            param.SourceColumn = "Состав заказа";
            this._adapter.InsertCommand.Parameters.Add(param);
            this._adapter.UpdateCommand = new global::Microsoft.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Заказы] SET [Id] = @Id, [Клиент] = @Клиент, [Дата заказа] = @Дата_заказа, [Дата доставки] = @Дата_доставки, [Состав заказа] = @Состав_заказа WHERE (([Id] = @Original_Id) AND ((@IsNull_Клиент = 1 AND [Клиент] IS NULL) OR ([Клиент] = @Original_Клиент)) AND ((@IsNull_Дата_заказа = 1 AND [Дата заказа] IS NULL) OR ([Дата заказа] = @Original_Дата_заказа)) AND ((@IsNull_Дата_доставки = 1 AND [Дата доставки] IS NULL) OR ([Дата доставки] = @Original_Дата_доставки)));
SELECT Id, Клиент, [Дата заказа], [Дата доставки], [Состав заказа] FROM Заказы WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Клиент, [Дата заказа], [Дата доставки], [Состав заказа] FROM dbo.Заказ" +
                "ы";
        ...
        public virtual int Fill(PetStoreDataSet3.ЗаказыDataTable dataTable) {
        ...
        public virtual PetStoreDataSet3.ЗаказыDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PetStoreDataSet3.ЗаказыDataTable dataTable = new PetStoreDataSet3.ЗаказыDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PetStoreDataSet3.ЗаказыDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Клиент, global::System.Nullable<global::System.DateTime> Original_Дата_заказа, global::System.Nullable<global::System.DateTime> Original_Дата_доставки) {
        ...
        public virtual int Insert(int Id, string Клиент, global::System.Nullable<global::System.DateTime> Дата_заказа, global::System.Nullable<global::System.DateTime> Дата_доставки, string Состав_заказа) {
            ...
            if ((Состав_заказа == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(Состав_заказа));
            }
        ...
        public virtual int Update(int Id, string Клиент, global::System.Nullable<global::System.DateTime> Дата_заказа, global::System.Nullable<global::System.DateTime> Дата_доставки, string Состав_заказа, int Original_Id, string Original_Клиент, global::System.Nullable<global::System.DateTime> Original_Дата_заказа, global::System.Nullable<global::System.DateTime> Original_Дата_доставки) {
            ...
            if ((Состав_заказа == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Состав_заказа));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Клиент, global::System.Nullable<global::System.DateTime> Дата_заказа, global::System.Nullable<global::System.DateTime> Дата_доставки, string Состав_заказа, int Original_Id, string Original_Клиент, global::System.Nullable<global::System.DateTime> Original_Дата_заказа, global::System.Nullable<global::System.DateTime> Original_Дата_доставки) {
            return this.Update(Original_Id, Клиент, Дата_заказа, Дата_доставки, Состав_заказа, Original_Id, Original_Клиент, Original_Дата_заказа, Original_Дата_доставки);
        }
    }
        ...
        public virtual int UpdateAll(PetStoreDataSet3 dataSet) {
            ...
            try {
                ...
                if ((this._заказыTableAdapter != null)) {
                    ...
                    this._заказыTableAdapter.Connection = ((global::Microsoft.Data.SqlClient.SqlConnection)(workConnection));
                    this._заказыTableAdapter.Transaction = ((global::Microsoft.Data.SqlClient.SqlTransaction)(workTransaction));
                ...
                if ((this._заказыTableAdapter != null)) {
                    this._заказыTableAdapter.Connection = ((global::Microsoft.Data.SqlClient.SqlConnection)(revertConnections[this._заказыTableAdapter]));
