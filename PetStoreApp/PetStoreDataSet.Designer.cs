...
namespace PetStoreApp.PetStoreDataSetTableAdapters {
...
SELECT Артикул, Название, Категория, Бренд, Животное, Описание, Состав, Единица, Стоимость, Количество_на_складе FROM Товары WHERE (Артикул = @Артикул)";
        ...
        public virtual int Fill(PetStoreDataSet.ТоварыDataTable dataTable) {
        ...
        public virtual PetStoreDataSet.ТоварыDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PetStoreDataSet.ТоварыDataTable dataTable = new PetStoreDataSet.ТоварыDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PetStoreDataSet.ТоварыDataTable dataTable) {
